...
public class ParseException extends Exception {
  ...
  private static String initialise(Token currentToken,
    ...
    String retval = "\n\nAnalizador: Ocurrió un error de sintaxis.\n";
    retval += "Se encontró \"";
    ...
    retval += "Hubo un error en la línea " + currentToken.beginLine + ", columna " + currentToken.beginColumn;
    ...
    if (expectedTokenSequences.length == 0) {
	    ...
	    if (expectedTokenSequences.length == 1) {
	      ...
	      retval += ", era esperado uno de estos símbolos o palabras reservadas:" + EOL + "    ";
	    }
